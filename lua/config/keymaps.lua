...
-- Use remap=true so mini.comment's gcc/gc mappings are used.
-- Direct string mapping preserves visual selection correctly (Lua function wrapper loses it).
vim.keymap.set("n", "<D-/>", "gcc", { remap = true, silent = true, desc = "Toggle line comment" })
vim.keymap.set("v", "<D-/>", "gc", { remap = true, silent = true, desc = "Toggle line comment" })
...
-- Window resize (15 units per press)
vim.keymap.set("n", "<leader>wl", ":vertical resize +15<CR>", { silent = true, desc = "Increase window width" })
vim.keymap.set("n", "<leader>wh", ":vertical resize -15<CR>", { silent = true, desc = "Decrease window width" })
vim.keymap.set("n", "<leader>wk", ":resize +15<CR>",          { silent = true, desc = "Increase window height" })
vim.keymap.set("n", "<leader>wj", ":resize -15<CR>",          { silent = true, desc = "Decrease window height" })
